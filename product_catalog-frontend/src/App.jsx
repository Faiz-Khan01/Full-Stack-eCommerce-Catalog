...
// const AdminSupportTickets = lazy(() => import("./Admin/AdminSupportTickets"));
...
//     style={{ minHeight: "70vh", background: "var(--bg, #090d16)" }}
//   >
...
//     style={{ background: "var(--bg, #090d16)", color: "var(--text-primary, #f8fafc)" }}
//   >
//     <div
//       className="text-center p-5 rounded-4 shadow-lg"
//       style={{ maxWidth: "480px", background: "var(--card, #111827)", border: "1px solid var(--border, #1f2937)" }}
//     >
//       <div className="display-1 fw-bold text-primary mb-2" style={{ color: "#10b981" }}>404</div>
...
//       <a href="/" className="btn btn-primary rounded-pill px-4 py-2 fw-semibold" style={{ background: "#10b981", border: "none" }}>
//         Back to Home
//       </a>
//     </div>
//   </div>
...
//     return saved ? saved === "dark" : true; // Default dark for sleek look
//   });
...
//   return (
//     <ThemeContext.Provider value={{ darkMode, toggleTheme, theme: darkMode ? themes.dark : themes.light }}>
//       {children}
...
//         }
//       } catch (err) {
//         console.warn("Category load warning:", err.message);
//       }
//     };
//     fetchCategories();
//   }, []);
...
//   return (
//     <div className="app-root" style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text-primary)" }}>
//       {/* NAVBAR */}
//       {!isAdminPage && (
//         <Navbar
...
//           <Route
//             path="/"
//             element={<Home searchTerm={searchTerm} selectedCategory={selectedCategory} sortOrder={sortOrder} />}
//           />
